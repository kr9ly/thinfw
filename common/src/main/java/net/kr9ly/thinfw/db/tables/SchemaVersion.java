...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
	...
	private static final long serialVersionUID = -1122289930;

	/**
	 * The reference instance of <code>thinfw.schema_version</code>
	 */
	...
	/**
	 * The column <code>thinfw.schema_version.version_rank</code>.
	 */
	...
	/**
	 * The column <code>thinfw.schema_version.installed_rank</code>.
	 */
	...
	/**
	 * The column <code>thinfw.schema_version.version</code>.
	 */
	...
	/**
	 * The column <code>thinfw.schema_version.description</code>.
	 */
	...
	/**
	 * The column <code>thinfw.schema_version.type</code>.
	 */
	...
	/**
	 * The column <code>thinfw.schema_version.script</code>.
	 */
	...
	/**
	 * The column <code>thinfw.schema_version.installed_on</code>.
	 */
	public final TableField<SchemaVersionRecord, LocalDateTime> INSTALLED_ON = createField("installed_on", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "", new LocalDateTimeConverter());

	/**
	 * The column <code>thinfw.schema_version.execution_time</code>.
	 */
	...
	/**
	 * The column <code>thinfw.schema_version.success</code>.
	 */
	...
	/**
	 * Create a <code>thinfw.schema_version</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>thinfw.schema_version</code> table reference
	 */
